...
export default function AddSeminaristForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Generate Metadata (Matricule, Age)
      // Note: In a real app, matricule is likely generated by the backend. 
      // We are simulating it here for the PDF.
      const tempMatricule = "SEM-" + Date.now().toString().slice(-6)
      ...
      const seminaristData: SeminaristData = {
        ...
        personalInfo: {
          ...
          sexe: formData.genre,
          age: calculatedAge,
          communeHabitation: formData.commune,
          niveauAcademique: formData.niveauEtude,
          contact: formData.contact,
        },
        dormitoryInfo: {
          dortoir: formData.dortoir,
          matricule: tempMatricule
        },
        healthInfo: {
          allergie: formData.allergies,
          antecedentMedical: formData.antecedents,
        },
      }

      // 2. Generate QR Code
      // We encode the matricule plus some other unique data
      ...
      await PDFGenerator.generateRegistrationPDF(seminaristData, qrCodeUrl)

      toast.success("Séminariste ajouté et reçu généré avec succès !")
      console.log("Form submitted with PDF generation:", formData)
